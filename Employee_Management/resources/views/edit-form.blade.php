...
<input type="text" name="fname" value = "{{$employee->first_name}}"placeholder="First Name">
</div>
</div>
<div class="col-xl-6 col-sm-12 col-12 ">
<div class="form-group">
<input type="text"name="lname"value = "{{$employee->last_name}}"placeholder="Last Name">
</div>
</div>
</div>
<div class="row">
...
<input type ="text" name = "country" value = "{{$employee->country}}" placeholder ="Country of Employment"/>

</div>
</div>
<div class="col-xl-6 col-sm-12 col-12 ">
<div class="form-group">
<input type="text" name= "wsd" value = "{{$employee->working_start_date}}"placeholder="Working Start Date (yyyy-mm-dd)">
</div>
 </div>
</div>
<div class="row">
<div class="col-xl-6 col-sm-12 col-12 ">
<div class="form-group">
<input type="text" value = "{{$employee->job_title}}" name ="jobtitle"placeholder="Job Title">
</div>
</div>
<div class="col-xl-6 col-sm-12 col-12 ">
<div class="form-group">
<select name ="jobtype" value = "{{$employee->job_type}}" class="select">
...
<input type ="text" name ="office" value = "{{$employee->office}}" placeholder ="Office"/>

</div>
</div>
<div class="col-xl-6 col-sm-12 col-12 ">
<div class="form-group">
<select name ="team" value = "{{$employee->team}}" class="select" >
...
<div class="col-xl-6 col-sm-12 col-12 ">
<div class="form-group">
<select name ="currency" value = "{{$employee->currency}}" class="select">
...
<div class="col-xl-6 col-sm-12 col-12 ">
<div class="form-group">
<select name ="frequency" value = "{{$employee->frequency}}" class="select">
...
<div class="col-xl-6 col-sm-12 col-12 ">
<div class="form-group">
<input type="text" name ="psd" value = "{{$employee->payment_start_date}}" placeholder="Payment Start Date (yyyy-mm-dd)">
</div>
</div>
</div>
</div>
...
<div class="col-xl-12 col-sm-12 col-12 ">
<div class="form-btn">
<input type="submit" style ="padding : 18px" class="btn btn-apply w-auto" value ="Update employee"/>
