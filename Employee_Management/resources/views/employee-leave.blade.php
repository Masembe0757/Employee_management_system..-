...
<form action= "/leave-data" method ="Post">
@csrf
...
<input type="text" style ="display : none" value = "{{ Auth::user()->name }}" name ="user">
</div>
</div>
</div>
...
<div class="card">
<div class="card-header">
<h2 class="card-titles">My Leave Details</h2>
</div>
...
<div class="card ">
<div class="card-header">
<h2 class="card-titles">My  Leaves</h2>
</div>
<div class="card-body p-0">
<div class="table-responsive">
<table class="table  custom-table  no-footer">
